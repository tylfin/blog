...
/***/ function(module, exports, __webpack_require__) {
	...
	var BlogPost = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('img', { src: this.props.img, className: 'thumbnail' }),
	      React.createElement(
	        'p',
	        null,
	        this.props.content
	...
	ReactDOM.render(React.createElement(BlogPostBox, { url: '/api/posts' }), document.getElementById('blogPost'));
